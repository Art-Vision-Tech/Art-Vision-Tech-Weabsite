...
function autenticar(email, senha) {
    ...
    var instrucao = `
    SELECT idFuncionario, nome, cnpj, nomeMuseu nomeMuseu, cpf, email, FkMuseu as museuId FROM Funcionario JOIN Museu on idMuseu = fkMuseu WHERE email = '${email}' AND senha = '${senha}';    `
